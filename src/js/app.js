Vue.component('nav-bar', {
    ...
    <nav class="navbar bg-info flex-row">
        <a id="home" href="/src/html/index.html"><img src="/images/coding-for-coconuts-logo.png" alt="Coding for Coconuts"/></a>
        <div>
...
// problems
let problem1 = new Problem(1, 1, "Learn sequences through story telling.", "Read the short story about Manny the Monkey. Then describe the correct order that events happened.", "walk,eat,swing,sleep");
